...
function Typography() {
  return (
    <div>
      <div className="max-w-3xl mx-auto py-20">
        <BaseProse shape="rounded" className="prose-md">
          ...
          <p>
            ...
            undoing user-agent styles, but when you
            <em>really are</em>
            just trying to style some content that came from a rich-text editor
          ...
          <p>
            ...
            annoying margins every time you use a<code>p</code>
            element in a piece of your dashboard UI. And I doubt you really want
            your blog posts to use the user-agent styles either — you want them
            to look
          ...
          <p>
            It adds a new
            <code>prose</code>
            class that you can slap on any block of vanilla HTML content and
  ...
  plugins: [],
          ...
          <p>
            ...
            <code>&lt;p&gt;</code>
            tag unless there are multiple paragraphs in the list item. That
            means I have to worry about styling that annoying situation too.
          </p>
          <ul>
            <li>
              <p>
              ...
              <ul>
                <li>
                  <p>
                    ...
                    list item now has a<code>&lt;p&gt;</code>
                    tag.
                  </p>
          ...
          <p>
            ...
            body copy. What are we supposed to do with an
            <code>h5</code>, make it
            <em>smaller</em>
